...
The browser remains a read-only evidence consumer. This bridge owns only the
localhost transport/process lifetime. Plant, estimator, controller, supervisor,
and authority semantics remain in the Rust `single_sitl_live` process.
"""
